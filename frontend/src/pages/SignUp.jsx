  ...
  return (
    <div className='w-[100vw] h-[100vh] flex items-center justify-center relative'>
      ...
      <form action="" className='max-w-[900px] w-[90%] h-[600px] flex items-center justify-center flex-col md:items-start gap-[10px]' onSubmit={handleSignUP}>
        ...
        <button className='px-[50px] py-[10px] bg-[#25409C] text-[white] text-[18px] md:px-[100px] rounded-lg mt-[20px]' disabled={loading}>{loading ? "Loading..." : "SignUp"}</button>
        <p className='text-[18px]'>Already have a account? <span className='text-[19px] text-[#25409C] cursor-pointer' onClick={() => navigate("/login")}>Login</span>
        </p>
      </form>
