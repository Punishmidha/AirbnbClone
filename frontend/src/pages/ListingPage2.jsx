...
function ListingPage2() {
    ...
    return (
        <div className='w-[100%] h-[100vh] bg-white flex items-center justify-center relative overflow-auto'>
            <div 
                className='w-[50px] h-[50px] bg-[#25409C] cursor-pointer absolute top-[5%] left-[20px] rounded-[50%] flex items-center justify-center' 
                onClick={()=>navigate("/listingpage1")}
            >
                <FaArrowLeftLong className='w-[25px] h-[25px] text-white' />
            </div>

            <div className='w-[200px] h-[50px] text-[20px] bg-[#25409C] text-white flex items-center justify-center rounded-[30px] absolute top-[5%] right-[10px] shadow-lg'>
            ...
            <div className='max-w-[900px] w-[100%] h-[550px] overflow-auto bg-white flex items-center justify-start flex-col gap-[40px] mt-[30px]'>
                ...
                <button 
                    className='px-[50px] py-[10px] bg-[#25409C] text-white text-[18px] md:px-[100px] rounded-lg absolute right-[5%] bottom-[5%]' 
